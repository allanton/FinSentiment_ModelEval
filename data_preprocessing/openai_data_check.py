# This is script provided by OpenAI to check 
# whether the formatting of the data is correct for fine-tuning
# and estimates runtime and cost of the fine-tuning job.
...
# Load dataset
with open(abs_train_json_file_path) as f:
